...
extern int (* OSSetThreadRunQuantum)(OSThread *thread, u32 quantumMicrosec); //Maximum time a thread can run for before being forced to yield
...
extern int (* OSRestartGame)(u32 argc, void *argv);
extern void (* OSForceFullRelaunch)(void);
extern u32 (* OSGetSymbolName)(u32 address, void *buffer, u32 bufsize);
extern int (* OSIsHomeButtonMenuEnabled)(void);
extern int (* OSEnableHomeButtonMenu)(int enable);
