...
#define WPAD_CLASSIC_BUTTON_STICK_L			0x00020000
#define WPAD_CLASSIC_BUTTON_STICK_R			0x00010000
...
extern s32 (* KPADRead)(s32 chan, KPADData *buffer, u32 size);
extern s32(*KPADReadEx)(s32 chan, KPADData *buffer, u32 count, s32 *error);
