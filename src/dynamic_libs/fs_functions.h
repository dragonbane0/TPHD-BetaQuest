...
extern FSAsyncResult* (* FSGetAsyncResult)(OSMessage *ioMsg);
...
extern int (* FSGetStatAsync)(void *pClient, void *pCmd, const char *path, FSStat *stats, int error, void *asyncParams);
extern int (* FSRename)(void *pClient, void *pCmd, const char *oldPath, const char *newPath, int error);
extern int (* FSRenameAsync)(void *pClient, void *pCmd, const char *oldPath, const char *newPath, int error, void *asyncParams);
extern int (* FSRemove)(void *pClient, void *pCmd, const char *path, int error);
extern int (* FSRemoveAsync)(void *pClient, void *pCmd, const char *path, int error, void *asyncParams);
...
extern int (* FSReadFileAsync)(void *pClient, void *pCmd, uint8_t *buffer, uint32_t size, uint32_t count, int fd, uint32_t flag, uint32_t errHandling, const void *asyncData);
extern int (* FSReadFileWithPos)(void *pClient, void *pCmd, void *buffer, int size, int count, int pos, int fd, int flag, int errHandling);
extern int (* FSReadFileWithPosAsync)(void *pClient, void *pCmd, void *buffer, int size, int count, int pos, int fd, int flag, int errHandling, const FSAsyncData *asyncData);
extern int (* FSCloseFile)(void *pClient, void *pCmd, int fd, int errHandling);
extern int (* FSCloseFileAsync)(void *pClient, void *pCmd, int fd, int errHandling, const void *asyncData);
...
extern int (* FSGetStatFile)(void *pClient, void *pCmd, int fd, FSStat *stats, int error);
extern int (* FSGetStatFileAsync)(void *pClient, void *pCmd, int fd, FSStat *stats, int error, const void *asyncData);
