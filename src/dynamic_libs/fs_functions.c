...
EXPORT_DECL(FSAsyncResult*, FSGetAsyncResult, OSMessage *ioMsg);
...
EXPORT_DECL(int, FSGetStatAsync, void *pClient, void *pCmd, const char *path, FSStat *stats, int error, void *asyncParams);
...
EXPORT_DECL(int, FSReadFileAsync, void *pClient, void *pCmd, uint8_t *buffer, uint32_t size, uint32_t count, int fd, uint32_t errHandling, uint32_t flag, const void *asyncData);
EXPORT_DECL(int, FSReadFileWithPos, void *pClient, void *pCmd, void *buffer, int size, int count, int pos, int fd, int flag, int errHandling);
EXPORT_DECL(int, FSReadFileWithPosAsync, void *pClient, void *pCmd, void *buffer, int size, int count, int pos, int fd, int flag, int errHandling, const FSAsyncData *asyncData);
EXPORT_DECL(int, FSCloseFile, void *pClient, void *pCmd, int fd, int errHandling);
EXPORT_DECL(int, FSCloseFileAsync, void *pClient, void *pCmd, int fd, int errHandling, const void *asyncParams);
...
EXPORT_DECL(int, FSGetStatFile, void *pClient, void *pCmd, int fd, FSStat *stats, int error);
EXPORT_DECL(int, FSGetStatFileAsync, void *pClient, void *pCmd, int fd, FSStat *stats, int error, const void *asyncData);
...
void InitFSFunctionPointers(void)
{
	...
	OS_FIND_EXPORT(coreinit_handle, FSGetAsyncResult);
	...
	OS_FIND_EXPORT(coreinit_handle, FSReadFileAsync);
	OS_FIND_EXPORT(coreinit_handle, FSReadFileWithPos);
	OS_FIND_EXPORT(coreinit_handle, FSReadFileWithPosAsync);
    OS_FIND_EXPORT(coreinit_handle, FSCloseFile);
	OS_FIND_EXPORT(coreinit_handle, FSCloseFileAsync);
	...
	OS_FIND_EXPORT(coreinit_handle, FSGetStatFileAsync);
